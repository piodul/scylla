...
public:
    group0_state_machine(raft_group0_client& client, migration_manager& mm, storage_proxy& sp, storage_service& ss, gms::feature_service& fs) : _client(client), _mm(mm), _sp(sp), _ss(ss), _fs(fs) {}
