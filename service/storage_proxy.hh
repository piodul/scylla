...
private:
    ...
    inheriting_concrete_execution_stage<
            ...
            service_permit,
            bool,
            cdc::augmentation_metadata> _mutate_stage;
...
private:
    ...
    template<typename Range>
    future<> mutate_internal(Range mutations, db::consistency_level cl, bool counter_write, tracing::trace_state_ptr tr_state, service_permit permit, std::optional<clock_type::time_point> timeout_opt = { }, cdc::augmentation_metadata cdc_metadata = { });
    ...
    future<> do_mutate(std::vector<mutation> mutations, db::consistency_level cl, clock_type::time_point timeout, tracing::trace_state_ptr tr_state, service_permit permit, bool, cdc::augmentation_metadata cdc_metadata);
