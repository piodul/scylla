...
public:
    ...
    db::rate_limiter::label& get_rate_limiter_label_for_op_kind(db::per_partition_rate_limit_options::operation_kind op_kind) {
        switch (op_kind) {
        case db::per_partition_rate_limit_options::operation_kind::write:
            return _rate_limiter_label_for_writes;
        case db::per_partition_rate_limit_options::operation_kind::read:
