...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , wait_for_hint_replay_before_repair_in_ms(this, "wait_for_hint_replay_before_repair_in_ms", liveness::LiveUpdate, value_status::Used, 0, "Time to wait before all hints on all nodes participating in repair are sent out, before proceeding with the repair itself (in milliseconds).")
