...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , hinted_handoff_enabled(this, "hinted_handoff_enabled", liveness::LiveUpdate, value_status::Used, db::hints::host_filter(db::hints::host_filter::enabled_for_all_tag()),
