...
private:
    ...
    void check_nonempty() const {
        if (!_eptr) {
            // TODO: Add a new exception class for this case
...
public:
    ...
    exception_container(const exception_container&) = delete;

    exception_container& operator=(exception_container&&) = default;
    exception_container& operator=(const exception_container&) = delete;
