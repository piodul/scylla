...
Using Service Level CQL commands, database administrators can set different workload prioritization levels (levels of service) for each workload without sacrificing latency or throughput.
