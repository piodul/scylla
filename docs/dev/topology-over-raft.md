...
- `final_global_barrier` - the topology coordinator performs a global barrier
  to make sure that the nodes receive the up-to-date raft topology state
  before the topology coordinator switches to normal operation.
