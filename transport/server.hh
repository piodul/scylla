...
private:
    ...
    private:
        ...
        std::unique_ptr<cql_server::response> make_rate_limit_error(int16_t stream, exceptions::exception_code err, sstring msg, const tracing::trace_state_ptr& tr_state, const service::client_state& client_state) const;
