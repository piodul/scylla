...
rate_limit_exception::rate_limit_exception(const sstring& ks, const sstring& cf) noexcept
    : cassandra_exception(exception_code::CONFIG_ERROR, prepare_message("Rate limit reached for partition in table {}.{}", ks, cf))
    { }
